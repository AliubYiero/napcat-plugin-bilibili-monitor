 ...
 *
 */
const instructionSetMapper: Record<string,
	Record<string, (ctx: NapCatPluginContext, event: OB11Message, commands: string[]) => void>> = {
	'live': {
		/**
		 * 添加直播间监听
		 */
...
export const instructionHandler = (
	...
	const [arg1, arg2, ...commands] = args.map(str => str.toLocaleLowerCase())
	if ( !arg1 || !arg2 ) {
		return;
	}
